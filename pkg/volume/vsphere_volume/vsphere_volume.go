...
func (v *vsphereVolumeProvisioner) Provision(pv *api.PersistentVolume) error {
...
func (v *vsphereVolumeProvisioner) NewPersistentVolumeTemplate() (*api.PersistentVolume, error) {
	// Provide dummy api.PersistentVolume.Spec, it will be filled in
	// vsphereVolumeProvisioner.Provision()
	return &api.PersistentVolume{
		ObjectMeta: api.ObjectMeta{
			GenerateName: "pv-vsphere-",
		...
		Spec: api.PersistentVolumeSpec{
			...
			Capacity: api.ResourceList{
				api.ResourceName(api.ResourceStorage): v.options.Capacity,
			},
